...
<?php else: ?>
<meta property="og:image" content="//<?php echo $_SERVER["SERVER_NAME"].SWB.$sysconf['template']['dir']; ?>/googlelike/img/logo.png"/>
<?php endif; ?>
...
<?php else: ?>
<meta property="twitter:image" content="//<?php echo $_SERVER["SERVER_NAME"].SWB.$sysconf['template']['dir']; ?>/googlelike/img/logo.png"/>
<?php endif; ?>
...
<!-- Script
============================================= -->
<script src="<?php echo $sysconf['template']['dir']; ?>/googlelike/js/jquery.min.js"></script>
...
<script src="<?php echo SWB; ?>template/googlelike/js/jquery.jcarousel.min.js"></script>
<script src="<?php echo $sysconf['template']['dir']; ?>/googlelike/js/jquery.transit.min.js"></script>
<script src="<?php echo $sysconf['template']['dir']; ?>/googlelike/js/bootstrap.min.js"></script>
<script src="<?php echo $sysconf['template']['dir']; ?>/googlelike/js/custom.js"></script>

<!-- Style Minified
============================================= -->
<link rel="stylesheet" type="text/css" href="<?php echo SWB; ?>template/googlelike/style.css" />
...
============================================= -->
<!-- For Developmet Only
<link rel="stylesheet/less" type="text/css" href="<?php echo SWB; ?>template/googlelike/style.min.css"/>
<script>less = { env: "development" };</script>
<script src="<?php echo $sysconf['template']['dir']; ?>/googlelike/js/less.min.js"></script>
-->