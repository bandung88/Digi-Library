          ...
          while ($book = $topbook->fetch_assoc()) :
            ...
            <li class="book">
              <a itemprop="name" property="name" href="./index.php?p=show_detail&amp;id=<?php echo $book['biblio_id'] ?>" title="<?php echo $book['title'] ?>">
                ...
                <img itemprop="image" src="./template/googlelike/img/book.png" alt="<?php echo $book['title'] ?>" />
              </a>
            </li>
            <?php 
            endif;
    ...
    <div class="row">
      <div class="col-lg-6 col-sm-3 col-xs-12">
        <div class="s-footer-tagline">
			<a href="index.php"><?php echo __('Home'); ?></a> &nbsp&nbsp
			<a target="_blank" href="index.php?p=visitor"><?php echo __('Visitor Counter'); ?></a>
		</div>
      </div>
