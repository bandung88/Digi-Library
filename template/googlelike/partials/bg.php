...
<div class="s-background animated fadeIn">
  ...
  <?php if($sysconf['template']['background_mode'] == 'none') : ?>
    <video loop autoplay muted>
      <source src='<?php echo $sysconf['template']['dir']; ?>/googlelike/video/bg.mp4' type='video/mp4' />
      Your browser does not support the video tag.
    </video>
  <?php elseif($sysconf['template']['background_mode'] == 'images') : ?>
    <img class="slider" src='<?php echo $sysconf['template']['dir']; ?>/googlelike/img/4.jpg'/>
    <img class="slider" src='<?php echo $sysconf['template']['dir']; ?>/googlelike/img/3.jpg'/>
    <img class="slider" src='<?php echo $sysconf['template']['dir']; ?>/googlelike/img/2.jpg'/>
    <img class="slider" src='<?php echo $sysconf['template']['dir']; ?>/googlelike/img/1.jpg'/>
  <?php else: ?>
