...
<main id="content" class="s-main" role="main">
    ...
    <!-- Search form
    ============================================= -->
    <div class="s-search-info animated fadeInUp delay1">
      <form action="index.php" method="get" autocomplete="on">
        ...
        <div class="marquee down">
		  ...
		  <img class="s-search-info animated flipInUp delay9" src="<?php echo $sysconf['template']['dir']; ?>/googlelike/img/doodles.gif" height ="auto" width = "auto"/>
		  </a><br>
      <a href="index.php" class="s-search-info">
          <div class="s-search-info-tagline animated fadeInUp delay3"><h1><?php echo $sysconf['library_name']; ?></h2></br></a>
		...
		<ul>
				...
				<a> <?php echo __('Select Language'); ?></label></a>
					<a>:</a>
						&nbsp
						<a href="index.php?select_lang=en_US"><?php echo __('English'); ?></a></li>
						&nbsp&nbsp
						<a href="index.php?select_lang=id_ID"><?php echo __('Indonesia'); ?></a></li>
						&nbsp&nbsp
						<a href="index.php?select_lang=ar_AR"><?php echo __('Arabic'); ?></a></li>
		</ul>
<?php endif; ?>
...
<script>
  ...
  $('.book img').error(function(){
    ...
    $(this).attr({
      src   : './template/googlelike/img/book.png',  
  ...
  $('.librarian-image img').error(function(){
    $(this).attr('src','./template/googlelike/img/avatar.jpg');
  });
